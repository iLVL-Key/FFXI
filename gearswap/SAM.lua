...
function aftercast(spell)
	...
	choose_set()
	if AutoStance and StanceTimer < AutoStanceWindow and not buffactive['amnesia'] and not spell.interrupted and not TownZones:contains(world.area) then
...
windower.register_event('status change', function(status)
	...
	if AutoStance and StanceTimer < AutoStanceWindow and (status == 1 or status == 0) and not buffactive['amnesia'] and not TownZones:contains(world.area) then
		if Stance == 'Seigan' and Seigan.recast and Seigan.recast == 0 then
