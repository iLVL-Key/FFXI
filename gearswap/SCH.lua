...
function choose_set(sublimation_activation)
	...
	local danger = (LowHP or DangerMode == 'On' or (DangerMode == "Auto" and TakingDamage and not melee)) and not midaction() and sets.danger or nil
...
function midcast(spell)
	...
	elseif spell.type == "WhiteMagic" then
		...
		elseif spell.skill == "Enhancing Magic" then
			...
			local phalanx = spell.english == "Phalanx" and sets.phalanx or nil
			...
			equip(set_combine(base_set, sets.enhancing, aquaveil, phalanx, regen, refresh, stoneskin, storm, enspells, protect, shell, penury_parsimony, perpetuance, light_arts))
		elseif spell.skill == "Enfeebling Magic" then
		...
		elseif act.category == 6 and msg == 100 then --Uses ability
			if act.param == 218 then --Accession
				active_accession = { --Player now has Accession active
					[act.actor_id] = clock + 60, --Accession wears off after 60 seconds
				}
			end
