...
TopVersion = 'Holy Circle' --Leave this alone, used for debugging purposes
...
windower.register_event('lose buff', function(buff)
	if buff == 270 or buff == 271 or buff == 272 or buff == 273 and NotiAftermath =='On' then --lose any aftermath
		...
		if HUD == 'On' then
			send_command('text aftermath text "Aftermath: None";text aftermath color 255 50 50;text notifications bg_transparency 1')
		else
